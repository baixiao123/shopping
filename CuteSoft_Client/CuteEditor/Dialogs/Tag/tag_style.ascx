...
var OxOf882=["ondblclick","navtd","shiftKey","style"]; Window_GetElement(window,OxOf882[0x1],true)[OxOf882[0x0]]=function (){if(event[OxOf882[0x2]]){ alert(element[OxOf882[0x3]].cssText) ;} ;}  ;
</script>
